              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="<?=BASEURL?>assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user1">
                    </div>
                ...
                <td class="align-middle">
                  <a href="/<?='project_pengaduan/',$_GET[0],'/',$_GET[1]?>/detail/<?=$a['id']?>" idkucuy="<?=$a['id']?>" class=" btn  bg-gradient-warning font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Detail">
                    DETAIL
                  </a>
                </td>
              </tr>
