...
class QrCode{
    ...
    {
        $this->setPath(realpath(__DIR__.'/../../../QrData'));
        $this->setImagePath(realpath(__DIR__.'/../../../img/QrAssets'));
        $this->setLabelFontPath(realpath(__DIR__.'/../../..//font/opensans.ttf'));
        $this->version = 5;
        $this->setText($text);
    }
    ...
    public function setErrorCorrection($error_correction)
    {
        if (!is_numeric($error_correction)) {
            $error_correction = 'LEVEL_'.strtoupper($error_correction);
